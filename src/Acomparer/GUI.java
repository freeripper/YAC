    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(friend_jScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 262, Short.MAX_VALUE))
        );
    ...
    private void connect_jButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_connect_jButtonActionPerformed
        ...
        if (serverAddress_jTextField.getText().isEmpty() == true) {
            ...
            try {
                ...
                String password = new String(password_jPasswordField.getPassword());
                User connectedUser = new User(username_jTextField.getText(), password);
                ClientVariables.setConnectedUser(connectedUser);
